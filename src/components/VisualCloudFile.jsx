...
import { setCurrentPath, setVisualDrawFile, setVisualDrawPostAlert } from '../actions';
...
export default function VisualCloudFile() {
  ...
  const visualDrawPostAlert = useSelector(state => state.visualDrawPostAlert);
  ...
  return (
    <>
      ...
      <Dialog
          open={visualDrawPostAlert}
          onClose={(event, reason) => {
            if (reason !== 'backdropClick') {
              dispatch(setVisualDrawPostAlert(false));
            }
          }}
        >
          ...
          <DialogActions>
            <Button onClick={() => dispatch(setVisualDrawPostAlert(false))}>닫기</Button>
          </DialogActions>
        </Dialog>
